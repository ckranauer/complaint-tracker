...
<section id="content">
  ...
  <section id="table_of_contents">
    ...
    <div id="_table_of_contents">
      <ul>
        ...
        <ul>
          <li><a href="#unpublishing-a-single-version-of-a-package">Unpublishing a single version of a package</a></li>
  ...
  <div id="_content"><h3 id="synopsis">Synopsis</h3>
    <p>To learn more about how the npm registry treats unpublish, see our <!-- raw HTML omitted --> unpublish policies
      <!-- raw HTML omitted --></p>
