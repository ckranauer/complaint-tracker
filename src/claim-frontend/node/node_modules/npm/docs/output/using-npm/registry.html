...
<section id="content">
  ...
  <section id="table_of_contents">
    ...
    <div id="_table_of_contents">
      <ul>
        ...
        <li><a href="#where-can-i-find-my-own--others-published-packages">Where can I find my own, &amp; other’s,
  ...
  <div id="_content"><h3 id="description">Description</h3>
    ...
    <p>The registry URL used is determined by the scope of the package (see
      <a href="../using-npm/scope.html"><code>scope</code></a>. If no scope is specified, the default registry is used,
      which is
